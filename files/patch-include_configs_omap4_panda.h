--- include/configs/omap4_panda.h.orig	2015-01-03 17:44:28.000000000 -0500
+++ include/configs/omap4_panda.h	2015-01-04 09:54:40.000000000 -0500
@@ -47,4 +47,76 @@
...
+	"\0" \
+	"SetupFdtfile=" \
+	  "env set fdt_file omap4-panda.dtb; " \
+	"\0" \
+	"SetupFatdev=" \
+	  "env exists fatdev || " \
